...
const PlanosPage = () => {
  // Textos para o SpeechButton (Acessibilidade)
    ...
    <div className="planos-container">
      ...
      <div className="planos-grid">
        ...
        <div className="plano-card">
          ...
          <button className="btn-plano btn-outline">
        ...
        <div className="plano-card destaque">
          ...
          <button className="btn-plano btn-cheio">
        ...
        <div className="plano-card card-coins-style">
          ...
          <hr />
          <button className="btn-plano btn-gold">
            Comprar Moedas
          </button>
        </div>
        ...
        <div className="plano-card">
          ...
          <hr />
          <button className="btn-plano btn-cheio mt-auto">
            Quero Destacar
          </button>
        </div>
